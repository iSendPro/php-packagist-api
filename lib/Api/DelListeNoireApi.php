...
class DelListeNoireApi
{
     ...
     * @param string $delliste_noire Doit valoir \&quot;1\&quot; (required)
     ...
     */
    public function delListeNoire($keyid, $delliste_noire, $num)
    {
        list($response) = $this->delListeNoireWithHttpInfo($keyid, $delliste_noire, $num);
        return $response;
    }
     ...
     */
    public function delListeNoireWithHttpInfo($keyid, $delliste_noire, $num)
    {
        // verify the required parameter 'keyid' is set
        if ($keyid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $keyid when calling delListeNoire');
        }
        // verify the required parameter 'delliste_noire' is set
        if ($delliste_noire === null) {
            throw new \InvalidArgumentException('Missing the required parameter $delliste_noire when calling delListeNoire');
        }
        ...
        // query params
        if ($delliste_noire !== null) {
            $queryParams['dellisteNoire'] = $this->apiClient->getSerializer()->toQueryValue($delliste_noire);
        }
        // query params
        if ($num !== null) {
